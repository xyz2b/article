...
<!--
======================================================================
正文已基于 glibc 2.36 (gcc:13 容器) 实测数据写就。发布前 TODO：
[ ] 上一篇链接 (#) 替换为真实掘金链接
[x] 顶部可视化页 front/tcache-visualizer.html 已制作（基于 v3 框架：
    分桶全景 + tcache/fastbin 链表特写，演示 free 头插 / malloc 头摘 /
    next 写入数据区 / tcache 满 7 溢出 fastbin / LIFO 摘取）
[ ] 若目标读者环境 glibc < 2.26（无 tcache）或 < 2.32（无 safe-linking），
    正文中相应描述需加版本注脚
======================================================================
-->
