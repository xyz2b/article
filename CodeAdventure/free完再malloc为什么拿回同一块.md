...
> 这是"一条代码的冒险之旅"系列的第三篇。上一篇讲 `malloc` 到底问谁要内存、`free` 又把内存还给了谁：《[一次 malloc(16)，到底是问谁要的内存](https://github.com/xyz2b/article/blob/main/CodeAdventure/一次malloc到底问谁要内存.md)》。
