...
上一篇《[free 完再 malloc 为什么拿回同一块](https://github.com/xyz2b/article/blob/main/CodeAdventure/malloc/free完再malloc为什么拿回同一块.md)》末尾讲 fastbin 时留了个钩子：
