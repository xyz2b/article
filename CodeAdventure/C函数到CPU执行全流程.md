...
![那个 + 的真身：addl 机器码 03 45 f8，eax=3+4=7，a/b/c 写在栈上的红区](figs/frame_13_add.png)
...
![callq 一瞬：返回地址 0x3e 压栈当路标，RIP 飞进 add](figs/frame_07_callq.png)
...
![main 序言跑完：RBP 钉死当基准线，RSP 向下挖出局部变量空间](figs/frame_04_main_frame.png)
...
![retq 弹回返回地址，add 的整块栈帧作废](figs/frame_17_ret.png)
...
![从信箱 %eax 取出 7 存进 x，int x = add(3,4) 完成](figs/frame_19_store.png)
...
![程序结束，栈面归零——一压一弹，干干净净](figs/frame_23_done.png)
